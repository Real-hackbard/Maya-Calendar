...
uses
  ...
  StdCtrls, ExtCtrls, XPman, Vcl.Dialogs;
...
var
  pictun,baktun,katun,tun,uinal,kin:integer;
...
begin
    ...
    begin
      bsimula.caption:='Stop';
      Edit3.Enabled := false;
      Edit4.Enabled := false;
      Edit10.Enabled := false;
      bdatum.Enabled := false;
      btagplus.Enabled := false;
      btagminus.Enabled := false;
      Button1.Enabled := false;
    end else begin
      bsimula.caption:='Simulation';
      Edit3.Enabled := true;
      Edit4.Enabled := true;
      Edit10.Enabled := true;
      bdatum.Enabled := true;
      btagplus.Enabled := true;
      btagminus.Enabled := true;
